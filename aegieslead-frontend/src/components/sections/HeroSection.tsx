      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-6 relative">
            {settings.hero_image ? (
              <div className="relative mx-auto rounded-3xl bg-white border border-slate-300 shadow-2xl p-2 sm:p-3 overflow-hidden hover-lift">
                <img
              ...
              <div className="relative mx-auto rounded-3xl bg-white border border-slate-300/90 shadow-2xl shadow-slate-900/10 overflow-hidden hover-lift">
                ...
                <div className="hidden sm:flex absolute bottom-4 right-4 bg-slate-900 text-white p-3.5 rounded-2xl shadow-2xl border border-slate-700 items-center gap-3 animate-float-slow">
            ...
            <div className="hidden sm:flex absolute -bottom-5 -left-4 bg-white border border-slate-200 shadow-xl px-4 py-2.5 rounded-2xl items-center gap-3 animate-float-reverse hover-lift">
